    ...
    >
      <Menu v-model:selectedKeys="selectedKeys" mode="inline">
        ...
        <SubMenu key="sub2" @titleClick="titleClick">
          ...
          >
          <Item key="passenger"
            ><RouterLink to="/passenger">通知公告</RouterLink></Item
          >
        </SubMenu>
        ...
        <SubMenu key="sub5" @titleClick="titleClick">
          ...
          <Item key="order"
            ><RouterLink to="/ticketList">车辆管理</RouterLink>
          </Item>
          <Item key="personalTicket">
            <RouterLink to="/personalTicket">预约任务管理</RouterLink>
          </Item>
          <Item key="passenger"
            ><RouterLink to="/passenger">人员管理</RouterLink></Item
          >
        </SubMenu>
      </Menu>
    </Sider>
